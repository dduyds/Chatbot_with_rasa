...
def send_sms(text_message, target_phone_number):
    sms_conn = http.client.HTTPConnection("d93yrv.api.infobip.com")

    sms_payload = json.dumps({
        "messages": [
            {
                "destinations": [{"to": target_phone_number}],
                "from": "447491163443",
                "text": text_message
            }
        ]
    ...
    sms_headers = {
        'Authorization': 'App 6999543c26ae20fc2a69bad4bf4784f5-2bb302b8-8ab3-4216-ab79-6708b8a71da8',
        # Replace with your actual authorization token
        'Content-Type': 'application/json',
        'Accept': 'application/json'
    }

    sms_conn.request("POST", "/sms/2/text/advanced", sms_payload, sms_headers)
    response = sms_conn.getresponse()
    if response.status == 200:  # 200 indicates success
        return f"Message sent successfully to {target_phone_number}."
    else:
        return f"Failed to send message to {target_phone_number}. Status: {response.status}."


BASE_API_URL = "https://api.langflow.astra.datastax.com"
LANGFLOW_ID = "c2f123c0-5ef3-4d46-9b7b-d0e233a09597"
FLOW_ID = "00685e82-4eca-44b7-a024-fb6e06910d11"
APPLICATION_TOKEN = "AstraCS:IGdCKEdEijRPYOrBzTrkZjUm:0dc394b4b56334efd6a53b5dd761ff609f4020c65be0d876877de34d100e4ddd"
...
TWEAKS = {
    ...
    "File-MnI3M": {},
    "Chroma-qzO1G": {},
    "Google Generative AI Embeddings-OeFqb": {},
    "Chroma-S6sdK": {},
    "GroqModel-IE8Ua": {}
}
...
def request_model(message: str):
    ...
    try:
        ...
        response_json = json.dumps(response, indent=1)
        response_dict = json.loads(response_json)
        output_text = response_dict['outputs'][0]['outputs'][0]['results']['message']['text']
        return output_text
